    ...
    return (
        <div className='flex flex-col bg-[#34363e] px-5'>
            ...
            <div className='flex justify-center items-center gap-5 py-10'>
                <div className='w-1/2 self-start flex flex-col gap-10'>
                    ...
                    <div className='text-gray-300 text-2xl flex flex-col gap-3'>
                        <p className='flex'>
                            <span className='text-red-400 text-3xl'><FaLocationDot /></span>&nbsp;Studying in College of Engineering, Guindy. Striding through year 3 in CSE department!
                        </p>
                        <p className='flex'>
                            <span className='text-red-400 text-3xl'><TbHanger /></span>&nbsp;Seems like you don't need accomodation.
                        </p>
                    </div>
                ...
                <div className='w-1/2 flex flex-col'>
                    <img src={devrloper} className='w-full object-contain' />
